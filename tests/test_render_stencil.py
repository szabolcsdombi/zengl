...
def test(ctx: zengl.Context):
    ...
    pipeline_1 = make_pipeline(ctx, [image, stencil], (1.0, 0.0, 0.0), {
        'fail_op': 'replace',
        'pass_op': 'replace',
    ...
    pipeline_2 = make_pipeline(ctx, [image, stencil], (0.0, 1.0, 0.0), {
        'fail_op': 'keep',
        'pass_op': 'keep',
        'depth_fail_op': 'keep',
        'compare_op': 'equal',
    ...
    pipeline_3 = make_pipeline(ctx, [image, stencil], (0.0, 0.0, 1.0), {
        'fail_op': 'keep',
        'pass_op': 'keep',
        'depth_fail_op': 'keep',
        'compare_op': 'equal',
