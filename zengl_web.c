...
extern void zengl_glCullFace(int);
extern void zengl_glClear(int);
extern void zengl_glTexParameteri(int, int, int);
extern void zengl_glTexImage2D(int, int, int, int, int, int, int, int, const void *);
extern void zengl_glDepthMask(int);
extern void zengl_glDisable(int);
extern void zengl_glEnable(int);
extern void zengl_glFlush();
extern void zengl_glDepthFunc(int);
extern void zengl_glReadBuffer(int);
extern void zengl_glReadPixels(int, int, int, int, int, int, void *);
extern int zengl_glGetError();
extern void zengl_glGetIntegerv(int, int *);
extern void zengl_glViewport(int, int, int, int);
extern void zengl_glTexSubImage2D(int, int, int, int, int, int, int, int, const void *);
extern void zengl_glBindTexture(int, int);
extern void zengl_glDeleteTextures(int, const int *);
extern void zengl_glGenTextures(int, int *);
extern void zengl_glTexImage3D(int, int, int, int, int, int, int, int, int, const void *);
extern void zengl_glTexSubImage3D(int, int, int, int, int, int, int, int, int, int, const void *);
extern void zengl_glActiveTexture(int);
extern void zengl_glBlendFuncSeparate(int, int, int, int);
extern void zengl_glGenQueries(int, int *);
extern void zengl_glBeginQuery(int, int);
extern void zengl_glEndQuery(int);
extern void zengl_glGetQueryObjectuiv(int, int, void *);
extern void zengl_glBindBuffer(int, int);
extern void zengl_glDeleteBuffers(int, const int *);
...
extern void zengl_glStencilFuncSeparate(int, int, int, int);
extern void zengl_glStencilMaskSeparate(int, int);
extern void zengl_glAttachShader(int, int);
extern void zengl_glCompileShader(int);
extern int zengl_glCreateProgram();
extern int zengl_glCreateShader(int);
extern void zengl_glDeleteProgram(int);
extern void zengl_glDeleteShader(int);
extern void zengl_glEnableVertexAttribArray(int);
extern void zengl_glGetActiveAttrib(int, int, int, int *, int *, int *, char *);
extern void zengl_glGetActiveUniform(int, int, int, int *, int *, int *, char *);
extern int zengl_glGetAttribLocation(int, const char *);
extern void zengl_glGetProgramiv(int, int, int *);
extern void zengl_glGetProgramInfoLog(int, int, int *, char *);
extern void zengl_glGetShaderiv(int, int, int *);
extern void zengl_glGetShaderInfoLog(int, int, int *, char *);
extern int zengl_glGetUniformLocation(int, const char *);
extern void zengl_glLinkProgram(int);
extern void zengl_glShaderSource(int, int, const void *, const int *);
extern void zengl_glUseProgram(int);
extern void zengl_glUniform1i(int, int);
extern void zengl_glUniform1fv(int, int, const void *);
extern void zengl_glUniform2fv(int, int, const void *);
extern void zengl_glUniform3fv(int, int, const void *);
extern void zengl_glUniform4fv(int, int, const void *);
extern void zengl_glUniform1iv(int, int, const void *);
extern void zengl_glUniform2iv(int, int, const void *);
extern void zengl_glUniform3iv(int, int, const void *);
extern void zengl_glUniform4iv(int, int, const void *);
extern void zengl_glUniformMatrix2fv(int, int, int, const void *);
extern void zengl_glUniformMatrix3fv(int, int, int, const void *);
extern void zengl_glUniformMatrix4fv(int, int, int, const void *);
extern void zengl_glVertexAttribPointer(int, int, int, int, int, intptr);
extern void zengl_glUniformMatrix2x3fv(int, int, int, const void *);
extern void zengl_glUniformMatrix3x2fv(int, int, int, const void *);
extern void zengl_glUniformMatrix2x4fv(int, int, int, const void *);
extern void zengl_glUniformMatrix4x2fv(int, int, int, const void *);
extern void zengl_glUniformMatrix3x4fv(int, int, int, const void *);
extern void zengl_glUniformMatrix4x3fv(int, int, int, const void *);
extern void zengl_glBindBufferRange(int, int, int, intptr, intptr);
extern void zengl_glVertexAttribIPointer(int, int, int, int, intptr);
extern void zengl_glUniform1uiv(int, int, const void *);
extern void zengl_glUniform2uiv(int, int, const void *);
extern void zengl_glUniform3uiv(int, int, const void *);
extern void zengl_glUniform4uiv(int, int, const void *);
extern void zengl_glClearBufferiv(int, int, const void *);
extern void zengl_glClearBufferuiv(int, int, const void *);
extern void zengl_glClearBufferfv(int, int, const void *);
extern void zengl_glClearBufferfi(int, int, float, int);
extern void zengl_glBindRenderbuffer(int, int);
extern void zengl_glDeleteRenderbuffers(int, const int *);
extern void zengl_glGenRenderbuffers(int, int *);
extern void zengl_glBindFramebuffer(int, int);
extern void zengl_glDeleteFramebuffers(int, const int *);
extern void zengl_glGenFramebuffers(int, int *);
extern void zengl_glFramebufferTexture2D(int, int, int, int, int);
extern void zengl_glFramebufferRenderbuffer(int, int, int, int);
extern void zengl_glGenerateMipmap(int);
...
extern void zengl_glDrawArraysInstanced(int, int, int, int);
extern void zengl_glDrawElementsInstanced(int, int, int, intptr, int);
extern int zengl_glGetUniformBlockIndex(int, const char *);
extern void zengl_glGetActiveUniformBlockiv(int, int, int, int *);
extern void zengl_glGetActiveUniformBlockName(int, int, int, int *, char *);
extern void zengl_glUniformBlockBinding(int, int, int);
extern void * zengl_glFenceSync(int, int);
extern void zengl_glDeleteSync(void *);
extern int zengl_glClientWaitSync(void *, int, long long);
extern void zengl_glGenSamplers(int, int *);
extern void zengl_glDeleteSamplers(int, const int *);
extern void zengl_glBindSampler(int, int);
extern void zengl_glSamplerParameteri(int, int, int);
