...
static PyType_Spec Loader_spec = {"zengl_webgl.Loader", sizeof(Loader), 0, Py_TPFLAGS_DEFAULT, Loader_slots};

static PyMethodDef module_methods[] = {
    {NULL},
};

static PyModuleDef module_def = {PyModuleDef_HEAD_INIT, "zengl_webgl", NULL, -1, module_methods};

extern PyObject * PyInit_zengl_webgl() {
