...
def make_gl():
    ...
    return {
        ...
        "glTexImage2D": ctypes.cast(
            load("glTexImage2D"), proc(void, GLenum, GLint, GLint, GLsizei, GLsizei, GLint, GLenum, GLenum, void_star)
        ),
        ...
        "glReadPixels": ctypes.cast(
            load("glReadPixels"), proc(void, GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, void_star)
        ),
        ...
        "glTexSubImage2D": ctypes.cast(
            load("glTexSubImage2D"),
            proc(void, GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, void_star),
        ),
        ...
        "glTexImage3D": ctypes.cast(
            load("glTexImage3D"),
            proc(void, GLenum, GLint, GLint, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, void_star),
        ),
        "glTexSubImage3D": ctypes.cast(
            load("glTexSubImage3D"),
            proc(void, GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, void_star),
        ),
        ...
        "glGetActiveAttrib": ctypes.cast(
            load("glGetActiveAttrib"),
            proc(void, GLuint, GLuint, GLsizei, GLsizei_star, GLint_star, GLenum_star, GLchar_star),
        ),
        "glGetActiveUniform": ctypes.cast(
        ...
        "glGetProgramInfoLog": ctypes.cast(
            load("glGetProgramInfoLog"), proc(void, GLuint, GLsizei, GLsizei_star, GLchar_star)
        ),
        "glGetShaderiv": ctypes.cast(load("glGetShaderiv"), proc(void, GLuint, GLenum, GLint_star)),
        "glGetShaderInfoLog": ctypes.cast(
            load("glGetShaderInfoLog"), proc(void, GLuint, GLsizei, GLsizei_star, GLchar_star)
        ),
        ...
        "glShaderSource": ctypes.cast(
            load("glShaderSource"), proc(void, GLuint, GLsizei, GLchar_star_star, GLint_star)
        ),
        ...
        "glUniformMatrix2fv": ctypes.cast(
            load("glUniformMatrix2fv"), proc(void, GLint, GLsizei, GLboolean, GLfloat_star)
        ),
        "glUniformMatrix3fv": ctypes.cast(
            load("glUniformMatrix3fv"), proc(void, GLint, GLsizei, GLboolean, GLfloat_star)
        ),
        "glUniformMatrix4fv": ctypes.cast(
            load("glUniformMatrix4fv"), proc(void, GLint, GLsizei, GLboolean, GLfloat_star)
        ),
        "glVertexAttribPointer": ctypes.cast(
            load("glVertexAttribPointer"), proc(void, GLuint, GLint, GLenum, GLboolean, GLsizei, void_star)
        ),
        "glUniformMatrix2x3fv": ctypes.cast(
            load("glUniformMatrix2x3fv"), proc(void, GLint, GLsizei, GLboolean, GLfloat_star)
        ),
        "glUniformMatrix3x2fv": ctypes.cast(
            load("glUniformMatrix3x2fv"), proc(void, GLint, GLsizei, GLboolean, GLfloat_star)
        ),
        "glUniformMatrix2x4fv": ctypes.cast(
            load("glUniformMatrix2x4fv"), proc(void, GLint, GLsizei, GLboolean, GLfloat_star)
        ),
        "glUniformMatrix4x2fv": ctypes.cast(
            load("glUniformMatrix4x2fv"), proc(void, GLint, GLsizei, GLboolean, GLfloat_star)
        ),
        "glUniformMatrix3x4fv": ctypes.cast(
            load("glUniformMatrix3x4fv"), proc(void, GLint, GLsizei, GLboolean, GLfloat_star)
        ),
        "glUniformMatrix4x3fv": ctypes.cast(
            load("glUniformMatrix4x3fv"), proc(void, GLint, GLsizei, GLboolean, GLfloat_star)
        ),
        "glBindBufferRange": ctypes.cast(
            load("glBindBufferRange"), proc(void, GLenum, GLuint, GLuint, GLintptr, GLsizeiptr)
        ),
        "glVertexAttribIPointer": ctypes.cast(
            load("glVertexAttribIPointer"), proc(void, GLuint, GLint, GLenum, GLsizei, void_star)
        ),
        ...
        "glFramebufferTexture2D": ctypes.cast(
            load("glFramebufferTexture2D"), proc(void, GLenum, GLenum, GLenum, GLuint, GLint)
        ),
        "glFramebufferRenderbuffer": ctypes.cast(
            load("glFramebufferRenderbuffer"), proc(void, GLenum, GLenum, GLenum, GLuint)
        ),
        "glGenerateMipmap": ctypes.cast(load("glGenerateMipmap"), proc(void, GLenum)),
        "glBlitFramebuffer": ctypes.cast(
            load("glBlitFramebuffer"),
            proc(void, GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLbitfield, GLenum),
        ),
        "glRenderbufferStorageMultisample": ctypes.cast(
            load("glRenderbufferStorageMultisample"), proc(void, GLenum, GLsizei, GLenum, GLsizei, GLsizei)
        ),
        "glFramebufferTextureLayer": ctypes.cast(
            load("glFramebufferTextureLayer"), proc(void, GLenum, GLenum, GLuint, GLint, GLint)
        ),
        "glMapBufferRange": ctypes.cast(
            load("glMapBufferRange"), proc(void_star, GLenum, GLintptr, GLsizeiptr, GLbitfield)
        ),
        ...
        "glDrawArraysInstanced": ctypes.cast(
            load("glDrawArraysInstanced"), proc(void, GLenum, GLint, GLsizei, GLsizei)
        ),
        "glDrawElementsInstanced": ctypes.cast(
            load("glDrawElementsInstanced"), proc(void, GLenum, GLsizei, GLenum, void_star, GLsizei)
        ),
        "glGetUniformBlockIndex": ctypes.cast(load("glGetUniformBlockIndex"), proc(GLuint, GLuint, GLchar_star)),
        "glGetActiveUniformBlockiv": ctypes.cast(
            load("glGetActiveUniformBlockiv"), proc(void, GLuint, GLuint, GLenum, GLint_star)
        ),
        "glGetActiveUniformBlockName": ctypes.cast(
            load("glGetActiveUniformBlockName"), proc(void, GLuint, GLuint, GLsizei, GLsizei_star, GLchar_star)
        ),
...
def make_wrapper(gl):
    ...
    def glReadPixels(
        x: GLint, y: GLint, width: GLsizei, height: GLsizei, format: GLenum, type: GLenum, pixels: void_star
    ):
        print("glReadPixels")
    ...
    def glVertexAttribPointer(
        index: GLuint, size: GLint, type: GLenum, normalized: GLboolean, stride: GLsizei, pointer: void_star
    ):
    ...
    return {
        ...
        "glTexImage2D": addr(
            proc(void, GLenum, GLint, GLint, GLsizei, GLsizei, GLint, GLenum, GLenum, void_star)(glTexImage2D)
        ),
        ...
        "glTexSubImage2D": addr(
            proc(void, GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, void_star)(glTexSubImage2D)
        ),
        ...
        "glTexImage3D": addr(
            proc(void, GLenum, GLint, GLint, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, void_star)(glTexImage3D)
        ),
        "glTexSubImage3D": addr(
            proc(void, GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLenum, void_star)(
                glTexSubImage3D
            )
        ),
        ...
        "glGetActiveAttrib": addr(
            proc(void, GLuint, GLuint, GLsizei, GLsizei_star, GLint_star, GLenum_star, GLchar_star)(glGetActiveAttrib)
        ),
        "glGetActiveUniform": addr(
            proc(void, GLuint, GLuint, GLsizei, GLsizei_star, GLint_star, GLenum_star, GLchar_star)(glGetActiveUniform)
        ),
        ...
        "glVertexAttribPointer": addr(
            proc(void, GLuint, GLint, GLenum, GLboolean, GLsizei, void_star)(glVertexAttribPointer)
        ),
        ...
        "glBlitFramebuffer": addr(
            proc(void, GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLbitfield, GLenum)(glBlitFramebuffer)
        ),
        "glRenderbufferStorageMultisample": addr(
            proc(void, GLenum, GLsizei, GLenum, GLsizei, GLsizei)(glRenderbufferStorageMultisample)
        ),
        ...
        "glDrawElementsInstanced": addr(
            proc(void, GLenum, GLsizei, GLenum, void_star, GLsizei)(glDrawElementsInstanced)
        ),
        ...
        "glGetActiveUniformBlockName": addr(
            proc(void, GLuint, GLuint, GLsizei, GLsizei_star, GLchar_star)(glGetActiveUniformBlockName)
        ),
